            ...
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <div class="btn-group-toggle" data-toggle="buttons">
                <label class="btn  item" :class="content.isEmotion? 'btn-primary': 'btn-outline-primary'" for="isEmotion">感情
                  <input type="checkbox" checked autocomplete="off" id="isEmotion" v-model="content.isEmotion" onclick="document.getElementById('emotion').style.display='none';return false;">
                </label>
              </div>
              <div class="btn-group-toggle ml-2" data-toggle="buttons">
