        ...
        <div class="from-group">
          ...
          <div class="hideChosen">
            ...
            <div class="btn-group btn-group-toggle my-1" data-toggle="buttons">
              <div class="btn-group-toggle" data-toggle="buttons">
                <label class="btn" for="isSex" :class="hidden.isEmotion? 'btn-outline-info': 'btn-info'"> {{hidden.isEmotion? '感情已隱藏': '感情已顯示'}}
                  <input type="checkbox" checked autocomplete="off" id="isSex" v-model="hidden.isEmotion">
                </label>
              </div>
              <div class="btn-group-toggle ml-2" data-toggle="buttons">
                <label class="btn" :class="hidden.isChild? 'btn-outline-info': 'btn-info'" for="isChild">{{hidden.isChild? '子息已隱藏': '子息已顯示'}}
                  <input type="checkbox" checked autocomplete="off" id="isChild" v-model="hidden.isChild">
                </label>
              </div>
              <div class="btn-group-toggle ml-2" data-toggle="buttons">
                <label class="btn" :class="hidden.isCareer? 'btn-outline-info': 'btn-info'" for="isCareer">{{hidden.isCareer? '事業已隱藏': '事業已顯示'}}
                  <input type="checkbox" checked autocomplete="off" id="isCareer" v-model="hidden.isCareer">
                </label>
              </div>
            </div>
          </div>
