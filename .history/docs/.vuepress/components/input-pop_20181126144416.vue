      ...
      <div class="card-body">
        <div class="from-group">
          ...
          <div class="hideChosen">
            ...
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <div class="btn-group-toggle" data-toggle="buttons">
                <label class="btn" for="isSex" :class="content.isEmotion? 'btn-outline-info': 'btn-info'"> {{content.isEmotion? '性別已隱藏': '性別已顯示'}}
                  <input type="checkbox" checked autocomplete="off" id="isSex" v-model="content.isEmotion">
                </label>
              </div>
              <div class="btn-group-toggle ml-2" data-toggle="buttons">
                <label class="btn" :class="content.isCalendar? 'btn-outline-info': 'btn-info'" for="isCalendar">{{content.isCalendar? '農曆已隱藏': '農曆已顯示'}}
