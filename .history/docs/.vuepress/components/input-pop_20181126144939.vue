        ...
        <div class="from-group">
          ...
          <div class="hideChosen">
            ...
            <div class="btn-group btn-group-toggle my-1" data-toggle="buttons">
              ...
              <div class="btn-group-toggle ml-2" data-toggle="buttons">
                <label class="btn" :class="hidden.isCalendar? 'btn-outline-info': 'btn-info'" for="isCalendar">{{hidden.isCalendar? '子息已隱藏': '子息已顯示'}}
                  <input type="checkbox" checked autocomplete="off" id="isCalendar" v-model="hidden.isCalendar">
                </label>
              </div>
              <div class="btn-group-toggle ml-2" data-toggle="buttons">
                <label class="btn" :class="hidden.isCalendar? 'btn-outline-info': 'btn-info'" for="isCalendar">{{hidden.isCalendar? '事業已隱藏': '事業已顯示'}}
                  <input type="checkbox" checked autocomplete="off" id="isCalendar" v-model="hidden.isCalendar">
                </label>
              </div>
            </div>
